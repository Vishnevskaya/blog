...
dict.calendar = {
	div:'-', 
	table:{
		'2011-10-31':'’эллоуин Ч канун ƒн¤ всех св¤тых', 
		'2011-11-01':'ƒень судебного пристава',
		'2011-11-19':'ƒень ракетных войск и артиллерии',
		'2011-12-12':'ƒень  онституции –оссийской ‘едерации',
		'2011-12-31':'ƒень —урка'
	}
};
...
-function () {
	...
	lang = {
		...
		mm:['¤нв', 'фев', 'мар', 'апр', 'май', 'июн', 'июл', 'авг', 'сен', 'окт', 'но¤', 'дек'],
...
* }
* @el:string
* @idxs:array - только дл¤ элемента select
*/
...
function hidTemp() { /* —пр¤тать всплывшее <>*/
